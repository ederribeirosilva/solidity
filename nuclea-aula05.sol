...
// 0x2F6BB2E531F9f0965cBDb42E29160D770A04ac1D
...
contract Aluguel {
    ...
    uint256 public constant numeroMaximoLegalDeAlugueisParaMulta = 3;
    ...
    */
    ...
    function simulaMulta(
        uint256 mesesRestantes,
    ...
    function reajustaAluguel(uint256 percentualReajuste) public {
        require(
            msg.sender == owner,
            "somente o dono do imovel pode reajustar o aluguel"
        );
    ...
    function aplicaMulta(uint256 mesesRestantes, uint256 percentual) public {
        ...
        for (
            uint numeroDeVoltas = 0;
            numeroDeVoltas < mesesRestantes;
            numeroDeVoltas = numeroDeVoltas + 2
        ) {
    ...
    function receberPagamento() public payable {
        ...
        DadosPagamento memory dPgto = DadosPagamento(
            block.timestamp,
            msg.value
        );
    ...
    function historicoDePagto()
        public
        view
        returns (uint valorTotalRecebido, uint numAluguelRecebido)
    {
